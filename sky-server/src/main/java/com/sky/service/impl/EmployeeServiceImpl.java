...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Result<String> saveEmployee(EmployeeDTO employeeDTO) {
        ...
        int count = employeeMapper.getUserCount(employee.getName());
        if(count > 0 ){
            return Result.error(employee.getUsername() + "已存在");
        };
    ...
    public Result<PageResult> page(EmployeePageQueryDTO employeeDTO) {
        ...
        Page<Employee> pageList = employeeMapper.pageQuery(employeeDTO);
